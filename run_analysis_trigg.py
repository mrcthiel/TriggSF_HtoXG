...
def gen() -> None:
    ...
    os.system("rm -rf outputs_trigg/gen_output.json")
    os.system("mkdir -p outputs_trigg/")
    ...
    gen_output_filename = "outputs_trigg/gen_output.json"
...
#    executor: CoffeaExecutors = CoffeaExecutors.iterative,
...
def merge() -> None:
    ...
    os.system("rm -rf outputs_trigg/*.root")

    print("\n\n\n--> Merging analysis outputs...")
    merger_log = output_merger()
    with open("outputs_trigg/output_merger.log", "w") as f:
        f.write(merger_log)
